...
<div id="synthesis-api-support">
  ...
  <div style="margin-left: 20px;">
    ...
    <ul>
      ...
      <li><strong>DeepSeek:</strong> LPU- tactical reasoning.</li>
    </ul>
   ...
   <h4>4. IMAGE_MANIFESTATION</h4>
    <ul>
      ...
      <li><strong>Google Nano Banana:</strong> Enterprise-grade image generation.</li>
   ...
   <h4>5. VIDEO_TEMPORAL_GENESIS</h4>
    <ul>
      ...
      <li><strong>Google Veo:</strong> Decentralized video transcoding infrastructure.</li>
